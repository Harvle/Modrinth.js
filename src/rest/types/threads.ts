...
import type {
    RESTReportItemTypeOptions,
    RESTThreadMessageBodyTypeOptions,
    RESTThreadMessageTypeOptions,
    RESTProjectStatusOptions
} from "./enums";
...
export interface RESTThreadMessageBodyStatusChange extends RESTThreadMessageBodyBase {
    type: RESTThreadMessageBodyTypeOptions.StatusChange;
    /**
